...
const routes = [
  ...
  { path: '/login', component: Login },
  {
    ...
    children: [
      ...
      { path: '/sysschedule', component: resolve => require(['../views/system/SysSchedule.vue'], resolve), meta: { requestLogin: true, permissions: true, isTab: true } },
      ...
      { path: '/wflowdesignold', component: resolve => require(['../views/workflow/WflowDesign.vue'], resolve), meta: { requestLogin: true, permissions: false, isTab: true } },
      { path: '/wflowdesign', component: resolve => require(['../views/workflow/WflowDesignCustom.vue'], resolve), meta: { requestLogin: true, permissions: true, isTab: true } },
