                ...
                <div class="components-list">
                    <div v-for="(item, listIndex) in leftComponents" :key="listIndex">
                        ...
                        <draggable class="components-draggable" :list="item.list"
                            :group="{ name: 'componentsGroup', pull: 'clone', put: false }" draggable=".components-item"
...
import { inputComponents, selectComponents, layoutComponents, formConf } from '@/components/form-designer/generator/config'
import drawingDefalut from '@/components/form-designer/generator/drawingDefalut'
import { exportDefault, beautifierConf, isNumberStr, titleCase, deepClone, isObjectObject } from '@/utils/index'
import { makeUpHtml, vueTemplate, vueScript, cssStyle } from '@/components/form-designer/generator/html'
import { makeUpJs } from '@/components/form-designer/generator/js'
import { makeUpCss } from '@/components/form-designer/generator/css'
import logo from '@/assets/logo.png'
import DraggableItem from '@/components/form-designer/DraggableItem'
import RightPanel from '@/components/form-designer/RightPanel'
import FormDrawer from '@/components/form-designer/FormDrawer'
import JsonDrawer from '@/components/form-designer/JsonDrawer'
import CodeTypeDialog from '@/components/form-designer/CodeTypeDialog'
...
<style lang="less" >
@import '@/styles/form-designer/index';
@import '@/styles/form-designer/home';
</style>