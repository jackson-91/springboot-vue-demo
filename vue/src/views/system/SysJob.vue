...
export default {
  ...
  methods: {
    ...
    delete() {
      ...
      this.$confirm("此操作将永久删除选择的任务, 是否继续?", "提示", {
        ...
        .then(() => {
          ...
          this.$http
            .post("/api/quartz/delete", delitems)
            .then((res) => {
              if (res.code == "0") {
                this.$message.success(res.msg);
                this.searchData();
    ...
    start() {
      ...
      this.$http
        .post("/api/quartz/start", this.$refs.multipleTable.selection)
        .then((res) => {
          if (res.code == "0") {
            this.$message.success(res.msg);
            this.searchData();
    ...
    enable() {
      ...
      this.$http
        .post("/api/quartz/resume", this.$refs.multipleTable.selection)
        .then((res) => {
          if (res.code == "0") {
            this.$message.success(res.msg);
            this.searchData();
    ...
    disable() {
      ...
      this.$http
        .post("/api/quartz/pause", this.$refs.multipleTable.selection)
        .then((res) => {
          if (res.code == "0") {
            this.$message.success(res.msg);
            this.searchData();
